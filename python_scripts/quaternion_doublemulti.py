...
ax.arrow(1, 0.05, -0.95, 0.0, color = 'orange', head_width = 0.05, head_length = 0.05, width = 0.01)
ax.arrow(0.05, 1, sqrt2/2 - 0.1, sqrt2/2 - 1 + 0.05, color = 'red', head_width = 0.05, head_length = 0.05, width = 0.01)
ax.arrow(-sqrt2/2, -sqrt2/2, sqrt2/2 - 0.05, 1 + sqrt2/2, color = 'orange', head_width = 0.05, head_length = 0.05, width = 0.01)
ax.arrow(0.05, 0.05 - 0.1, 0.95, 0.0, color = 'red', head_width = 0.05, head_length = 0.05, width = 0.01)
ax.arrow(0.05, 1 - 0.1, sqrt2/2 - 0.1, sqrt2/2 - 1 + 0.05, color = 'orange', head_width = 0.05, head_length = 0.05, width = 0.01)
ax.arrow(sqrt2/2, sqrt2/2 - 0.1, -sqrt2/2 + 0.05, -sqrt2/2 - 0.85, color = 'red', head_width = 0.05, head_length = 0.05, width = 0.01)
plt.savefig('public/quaternion_double_multiply.png')