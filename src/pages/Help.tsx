...
function Help(){
    ...
    return <div className = 'min-w-fit w-full h-full flex flex-col items-center justify-around'>
        ...
        <form onSubmit = {() => {submit()}} className = 'w-9/10 flex flex-col gap-[20px]'>
            ...
            <div className = 'flex w-full justify-center items-center'>
                <button type='submit' className = 'min-w-[50px] w-[1/10] border-2 rounded-2xl cursor-pointer'>Send</button>
            </div>
        </form>
    </div>
}
